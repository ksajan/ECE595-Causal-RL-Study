...
- After their current SAC processes exit, node 1 runs Hopper-medium-v2
  fresh-residual seed 9 and node 5 runs factual-residual seed 9. Fresh-residual
  ownership was moved from a still-waiting node-4 watcher when node 1 completed
  two SAC arms earlier; node 4 had not created a D4RL run directory. The original
...
nodes 1, 4, and 5 and verified against the node-2 source:
...
All four participating nodes reported identical hashes for the D4RL runner
